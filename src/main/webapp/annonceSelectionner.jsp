...
<style>
      ...
      #map {
        ...
        width: 850px;  /* The width is the width of the web page */
...
<body>
		...
		<div class="block " >
			...
			<div class="card bg-secondary text-white" >
				...
				<ul class="list-group list-group-flush bg-secondary text-white">
					<li class="list-group-item text-center bg-secondary text-white  ">Prix : <c:out
							value="${annonceSelect.prix}" /></li>
				</ul>
				<ul class="list-group list-group-flush">
					<li class="list-group-item  text-center bg-secondary text-white">Localisation : <c:out
				...
				<div class="card-body  ">
					...
					<div class="card-body  ">
					<h5 class="card-title text-center  ">	Mail : <c:out value="${annonceSelect.compte.mail}" />
						</h5>
						<p class="card-text text-center">
 ...
 <h3 class="text-center">Localisation de l'annonce</h3>
